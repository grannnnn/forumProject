...
function indexPortfolioAction() {
    ...
    $rez = $mysqli->query("SELECT COUNT(*) as art_count FROM article WHERE user_name = '$_SESSION[login]'");
...
$query = $mysqli->query("SELECT * FROM article WHERE user_name = '$_SESSION[login]' LIMIT $u_page,$u_a_u");
